...
const tokens = {
  ...
  USDT: { address: USDT_ADDRESS, abi: USDT_ABI, decimals: 6, chainId: USDT_CHAIN_ID, chainName: USDT_CHAIN_NAME, rpc: USDT_RPC_URL, explorer: USDT_EXPLORER_URL, image: USDT_LOGO_URL },
} as const;
